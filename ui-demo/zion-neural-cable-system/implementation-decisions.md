...
- Only the active session emits a signal packet. Packet speed is approximately `180 px/s`; after the tail clears the route, the cable rests for `1.2 s` before the next packet.
